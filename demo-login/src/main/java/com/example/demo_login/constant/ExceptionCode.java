package com.example.demo_login.constant;

public class ExceptionCode {
    public static final String BAD_REQUEST_CODE = "com.example.Demo-login.exception.base.BadRequestException";
    public static final String CONFLICT_CODE = "com.example.Demo-login.exception.base.ConflictException";
    public static final String NOT_FOUND_CODE = "com.example.Demo-login.exception.base.NotFoundException";
    public static final String DUPLICATE_CODE = "com.example.Demo-login.exception.DuplicateNameException";
